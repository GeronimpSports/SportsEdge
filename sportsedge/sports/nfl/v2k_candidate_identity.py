"""Immutable identity binding for NFL V2K research artifacts.

This module grants no Model_P, promotion, staking, or OFFICIAL authority.
"""
...
SCHEMA = "SPORTSEDGE_NFL_V2K_CANDIDATE_IDENTITY_V1"
...
def build_candidate_identity(*, prereg_sha256: str, code_sha256: str,
                             ...
                             fold_definition_sha256: str, environment_lock_sha256: str,
                             rng_policy: Mapping[str, object]) -> dict:
...
def bind_distribution(distribution: Mapping[str, object], *, candidate_identity_sha256: str,
    ...
    out = {
        "schema": "SPORTSEDGE_NFL_V2K_BOUND_DISTRIBUTION_V1",
