...
MLB remains parked for automatic 2026 use on current main. This checker is an
operational/manual dead-man component only; it changes no model, pricing,
Truth Gate, deployment, or promotion authority.
"""
